...
class TianJinSzfwjSpider(scrapy.Spider):
    ...
    def start_requests(self):
        try:
            url = "http://www.nx.gov.cn/zwgk/qzfwj/list.html"
    ...
    def parse_page(self, response):
        ...
        try:
            ...
            for pagenum in range(page_count):
                url = "http://www.nx.gov.cn/zwgk/qzfwj/list_" + \
                      str(pagenum) + ".html" if pagenum > 0 else "http://www.nx.gov.cn/zwgk/qzfwj/list.html"

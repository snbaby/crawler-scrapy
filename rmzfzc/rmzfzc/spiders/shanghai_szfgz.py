...
class TianJinSzfwjSpider(scrapy.Spider):
    ...
    def start_requests(self):
        try:
            url = "http://www.shanghai.gov.cn/nw2/nw2314/nw2319/nw2407/nw45024/index.html"
            yield SplashRequest(url, args={'lua_source': script, 'wait': 1}, callback=self.parse_year)
        ...
        try:
            ...
            if not self.add_pagenum:
                return len(response.xpath(
                    '//*[@class="pagination pagination-centered"]/ul/li/a[contains(@title,"第")]/@href').extract())
    ...
    def parse_item(self, response):
        try:
            ...
            item['module_name'] = '上海市人民政府-市政府规章'
            item['spider_name'] = 'shanghai_szfgz'

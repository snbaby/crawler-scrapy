...
class TianJinSzfwjSpider(scrapy.Spider):
    ...
    def start_requests(self):
        try:
            url = "http://zwgk.qh.gov.cn/szfjdhy/bmjd/index.html"
    ...
    def parse_page(self, response):
        ...
        try:
            ...
            for pagenum in range(page_count):
                url = "http://zwgk.qh.gov.cn/szfjdhy/bmjd/index_" + \
                      str(pagenum) + ".html" if pagenum > 0 else "http://zwgk.qh.gov.cn/szfjdhy/bmjd/index.html"
    ...
    def parse_pagenum(self, response):
        try:
            ...
            if not self.add_pagenum:
                self.add_pagenum = int(response.xpath('//div[@class="zw-page pt18"]').re(r'([1-9]\d*\.?\d*)')[65])

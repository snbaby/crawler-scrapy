...
class BeijingZfwjSpider(scrapy.Spider):
    ...
    def start_requests(self):
        try:
            url = "http://xxgk.jl.gov.cn/szf/zcjd/index.html"
    ...
    def parse_pagenum(self, response):
        try:
            ...
            if not self.add_pagenum:
                return int(response.xpath('//*[@class="lv_menu_fanye"]').re(r'([1-9]\d*\.?\d*)')[0])
        ...
        try:
            ...
            if response.xpath('//table[@class="bd1"]/tbody/tr[4]/td[2]'):
                ...
                article_num = response.xpath(
                    '//div[@class="TRS_Editor"]/p[1][contains(text(),"〔")]/text()').extract_first()

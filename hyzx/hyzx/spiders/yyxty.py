    ...
    def start_requests(self):
        try:
            ...
            for content in contents:
                yield scrapy.FormRequest(content['url'],meta=content, formdata=data, method='POST', headers={'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'}, callback=self.parse_page, dont_filter=True)
        ...
        try:
            for pagenum in range(page_count):
                ...
                data = {
                    ...
                    'pageSize': '1500',
                    'i': '0'}
                yield scrapy.FormRequest(response.meta['url'], formdata=data, method='POST', headers={'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'}, callback=self.parse, dont_filter=True)
        except Exception as e:
            logging.error(self.name + ": " + e.__str__())
            logging.exception(e)
